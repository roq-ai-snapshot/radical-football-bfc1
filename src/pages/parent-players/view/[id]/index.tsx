...
import { getParentPlayerById } from 'apiSdk/parent-players';
        ...
        {isLoading ? (
          ...
          <>
            {hasAccess('parent_player', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
              <NextLink href={`/parent-players/edit/${data?.id}`} passHref legacyBehavior>
                <Button
