...
CREATE TABLE "parent_player" (
    ...
    CONSTRAINT "parent_player_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "parent_player" ADD CONSTRAINT "parent_player_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "parent"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "parent_player" ADD CONSTRAINT "parent_player_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
